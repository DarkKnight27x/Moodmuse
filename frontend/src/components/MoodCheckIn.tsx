...
const responses: Record<string, string> = {
  default:
    "I hear you. Based on what you've shared, I'm tuning your next mix toward warmer tones, slower tempos, and fewer lyrical hooks — something to sit with rather than perform to.",
}
...
export default function MoodCheckIn() {
  ...
  const submit = (text: string) => {
    ...
    setResponse(null)
    setLastMood(text)
    // Simulated AI analysis latency — replace with real POST to /mood-analysis
    setTimeout(() => {
      setLoading(false)
